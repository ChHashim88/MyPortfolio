    ...
    <nav className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="text-2xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Hashim</div>
        ...
        {isOpen && (
          <div className="md:hidden mt-2 space-y-2 px-2 pb-3">
            ...
            <a href="#contact" className="block text-gray-600 hover:text-blue-600 transition">Contact</a>
          </div>
        )}
      </div>
    </nav>
